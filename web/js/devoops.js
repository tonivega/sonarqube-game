...
function MorrisDashboard(){
    UpdateIssueCount(model.issues.count.url);
    UpdateWeekDayDeltasIssueCount(model.issues.delta.url)
	...
	Morris.Donut({
		...
		data: [
			{value: 70, label: '130€', formatted: 'to be paid' },
			{value: 30, label: '70€', formatted: 'unclaimed yet' },
		],
	...
	//	data: [
	//		{value: 20, label: 'majors', formatted: '200' },
	//		{value: 35, label: 'minors', formatted: '350' },
	//		{value: 20, label: 'criticals', formatted: '200' },
	//		{value: 25, label: 'blockers', formatted: '250' }
	//	],
	//	formatter: function (x, data) { return data.formatted; }
	//});
	Morris.Donut({
		...
		data: [
			{value: 17, label: 'monday', formatted: '10' },
			{value: 22, label: 'tuesday', formatted: '50' },
			{value: 10, label: 'wednesday', formatted: '0' },
			{value: 25, label: 'thursday', formatted: '20' },
			{value: 25, label: 'friday', formatted: '10' }
		],
		formatter: function (x, data) { return data.formatted; }
	});
	Morris.Bar({
...
function UpdateWeekDayDeltasIssueCount( url ){


    var success = function(dataset){

        var decimal_data = dataset;
        Morris.Line({
            element: 'morris-week-deltas',
            data: decimal_data,
            xkey: 'day',
            ykeys: ['Blocker', 'Critical', 'Major', 'Minor', 'Info'],
